...
class CryptoTwitterUserReplyGraph(CryptoUserReplyGraph):
    ...
    def configure(self, index_name: str) -> None:
        ...
        self.data_config = CryptoChatterDataConfig(
            ...
            node_id_col='id',
            raw_snapshot_dir = DATA_DIR / f'twitter/{index_name}/new_snapshots',
            graph_dir = DATA_DIR / f'twitter/{index_name}/user-reply',
            graph_gephi_dir = DATA_DIR / f'twitter/{index_name}/user-reply/gephi',
            graph_components_dir = DATA_DIR / f'twitter/{index_name}/user-reply/components',
            graph_stats_file = DATA_DIR / f'twitter/{index_name}/user-reply/stats.json',
            graph_edges_file = DATA_DIR / f'twitter/{index_name}/user-reply/edges.json',
            graph_nodes_file = DATA_DIR / f'twitter/{index_name}/user-reply/nodes.json',
            graph_data_file = DATA_DIR / f'twitter/{index_name}/user-reply/graph_data.pkl',
